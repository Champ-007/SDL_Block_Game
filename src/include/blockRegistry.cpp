...
namespace BlockRegistry
{
    ...
    void Init()
    {
        ...
        RegisterBlock({"grass",         320, 0,   0,   true,  15, false, true,  false, 10, {
            std::make_shared<DirtSoakBehavior>(),
        ...
        RegisterBlock({"lava",          0,   0,   255, false, 5,  true,  false, true,  6,  {
            std::make_shared<LiquidFlowBehavior>(),
            std::make_shared<LiquidCombineBehavior>(),
        ...
        RegisterBlock({"trapdoor",      404, 0,   0,   true,  15, false, true,  true,  10, {
            std::make_shared<trapdoorBehavior>(),
        }});
        RegisterBlock({"soil",          13,  0,   0,   true,  15, false, true,  false, 10, {
            std::make_shared<SoilDryOutBehavior>(),
        }});
        RegisterBlock({"wheat",  117, 0,   0,   true,  10, false, false, true,  10, {
            std::make_shared<sproutGrowthBehavior>(),
        }});
    }
}